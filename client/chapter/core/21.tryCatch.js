...
// 바로 실행되는 것이 아닌, 사용자가 어떤 인터랙션(행동)을 했을 때 코드 로직이 실행되는 경우
try {
  // let a = 5;
  // a + b;
...
try {
  ...
  console.log('JSON Error:', error.message); // 에러 다시 던지기
  // confirm('해당 데이터를 불러오는 데 실패했습니다. 다시 시도할까요?') // 예외 처리
  // document.body.innerHTML = '해당 데이터를 불러오는 데 실패했습니다.';
